...
const FarmersPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">{t("ourFarmersTitle")}</h1>
      ...
      {filteredFarmers.length > 0 ? (
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold mb-2">{t("noFarmersFound")}</h3>
          <p className="text-gray-600">{t("tryAdjustFarmers")}</p>
        </div>
      )}
    </div>
  );
